// aggregator.js (UPDATED with new RSS Feeds)

const Parser = require('rss-parser');
// Configure parser to find media tags
...
const RSS_FEEDS_MASTER = [
    ...
    { name: 'Game Rant', url: 'https://gamerant.com/feed/' }, // Corrected URL
    ...
    { name: 'SB Nation', url: 'https://www.sbnation.com/rss/index.xml' }, // Corrected URL
    ...
    { name: 'Stuff You Should Know', url: 'https://feeds.megaphone.fm/stuffyoushouldknow' } // Corrected name
];
        ...
        try {
            ...
            const processedItems = rss.items.map(item => {
                ...
                return {
                    ...
                    originalImageUrl: originalImageUrl // Save to database
                };
            }).slice(0, 5); // Get the 5 most recent from each feed
...
module.exports = {
    startScheduler: () => {
        ...
        fetchAndProcessNews(); // Fetch immediately on start
    },
    getNews: db.getAllArticles // Keep using the database function
};